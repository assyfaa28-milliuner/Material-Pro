...
const Dashboard = ({ currentUser, cartItemCount, onNavigateToProfile, onProductClick, onCartClick }) => {
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3 text-white">
              <button onClick={onCartClick} className="relative p-1">
                ...
                {cartItemCount > 0 && (
                  <span className="absolute top-0 right-0 bg-[#ffb900] text-[#7d0f0f] text-[10px] font-bold px-1.5 py-0.5 rounded-full transform translate-x-1 -translate-y-1">
                    {cartItemCount}
                  </span>
                )}
              </button>
